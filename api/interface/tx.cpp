...
PAUSE_D_REQ(utxo_req)
PARSE_JSON(addr)
D_END

DOUMP_D_REQ(utxo_req)
TO_JSON(addr)
D_END_R

PAUSE_D_ACK(utxo_ack)
PARSE_JSON(utxo)
PARSE_JSON(balance)
D_END

DOUMP_D_ACK(utxo_ack)
TO_JSON(utxo)
TO_JSON(balance)
D_END_R
//=======================
...
PAUSE_D_ACK(deploy_contract_ack)

D_END

DOUMP_D_ACK(deploy_contract_ack)
...
PAUSE_D_ACK(call_contract_ack)

D_END

DOUMP_D_ACK(call_contract_ack)
