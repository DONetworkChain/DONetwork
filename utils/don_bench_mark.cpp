...
DONbenchmark::DONbenchmark() : _benchmarkSwitch(false), transactionInitiateAmount(0), transactionInitiateHeight(0)
{
...
void DONbenchmark::_CaculateTransactionInitiateAmountPerSecond()
{
    if (!_benchmarkSwitch)
    {
        return;
...
void DONbenchmark::AddtransactionMemVerifyMap(const std::string& txHash, uint64_t costTime)
{
    if (!_benchmarkSwitch)
    {
        return;
...
void DONbenchmark::AddtransactionDBVerifyMap(const std::string& txHash, uint64_t costTime)
{
    if (!_benchmarkSwitch)
    {
        return;
...
void DONbenchmark::AddTransactionSignReceiveMap(const std::string& txHash)
{
    if (!_benchmarkSwitch)
    {
        return;
...
void DONbenchmark::CalculateTransactionSignReceivePerSecond(const std::string& txHash, uint64_t composeTime)
{
    if (!_benchmarkSwitch)
    {
        return;
...
void DONbenchmark::AddBlockContainsTransactionAmountMap(const std::string& blockHash, int txAmount)
{
    if (!_benchmarkSwitch)
    {
        return;
...
void DONbenchmark::AddBlockVerifyMap(const std::string& blockHash, uint64_t costTime)
{
    if (!_benchmarkSwitch)
    {
        return;
...
void DONbenchmark::AddBlockPoolSaveMapStart(const std::string& blockHash)
{
    if (!_benchmarkSwitch)
    {
        return;
...
void DONbenchmark::AddBlockPoolSaveMapEnd(const std::string& blockHash)
{
    if (!_benchmarkSwitch)
    {
        return;
...
void DONbenchmark::SetBlockPendingTime(uint64_t pendingTime)
{
...
void DONbenchmark::PrintBenchmarkSummary(bool exportToFile)
{
    if (!_benchmarkSwitch)
    {
        return;
...
void DONbenchmark::PrintBenchmarkSummary_DoHandleTx(bool exportToFile)
{
    if (!_benchmarkSwitch2)
    {
        return;
