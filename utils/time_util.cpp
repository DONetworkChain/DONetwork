...
x_uint64_t TimeUtil::GetDispathContractCycleTime(const x_uint64_t& utcTime)
{
    x_uint64_t minutes = utcTime / global::ca::contractWaitingTime;  // Convert timestamp
    return minutes *  global::ca::contractWaitingTime;
}
