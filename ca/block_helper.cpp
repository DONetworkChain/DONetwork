    ...
    ON_SCOPE_EXIT{
        ...
        if (reader.GetBlockTop(newTop) == DBStatus::DB_SUCCESS)
        {
            if (nodeHeight != newTop)
            {
                ...
                DEBUGLOG("NotifyNodeHeightChange update ok, oldHeight:{}, newTop:{}.", nodeHeight, newTop);
            }
        }
