 ...
 * *****************************************************************************
 */
#ifndef _ContractTransactionEntity_H_
#define _ContractTransactionEntity_H_
...
class ContractTransactionEntity
{
    private:
    ...
    public:
        ContractTransactionEntity(CTransaction transaction, uint64_t height, bool executedBefore)
			 : _transaction(transaction), _height(height), _executedBefore(executedBefore){};
		ContractTransactionEntity() = default;
        ~ContractTransactionEntity() = default;
