...
void BlockInvert(const CBlock & block, nlohmann::json &blocks)
{
    nlohmann::json allTx;
...
std::string PrintCache(int where){
    ...
    auto TFPBenchMark_C=  MagicSingleton<DONbenchmark>::GetInstance();
    ...
    switch (where) {
        ...
        case 3:
        {
            ...
            MagicSingleton<DONbenchmark>::DesInstance();
