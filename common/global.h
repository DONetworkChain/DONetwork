 ...
 * @LastEditTime: 2024-12-27 09:18:29
...
namespace global{
    ...
    */
        static const std::string kNetVersion = "3.3";
        static const std::string kLinuxCompatible = "3.3.0";
        static const std::string kWindowsCompatible = "3.3.0";
